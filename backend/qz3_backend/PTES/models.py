...
class InformationGathering(models.Model):
    pentest = models.ForeignKey(Pentest, on_delete=models.CASCADE, null=True, blank=True,
                                related_name="InformationGathering")
...
class VulnerabilityAnalysis(models.Model):
    pentest = models.ForeignKey(Pentest, on_delete=models.CASCADE, null=True, blank=True,
                                related_name="VulnerabilityAnalysis")
...
class AccessMaintenance(models.Model):
    pentest = models.ForeignKey(Pentest, on_delete=models.CASCADE, null=True, blank=True,
                                related_name="AccessMaintenance")
...
class DataAnalysisAndDocumentation(models.Model):
    pentest = models.ForeignKey(Pentest, on_delete=models.CASCADE, null=True, blank=True,
                                related_name="DataAnalysisAndDocumentation")
...
class AuditPreparationAndPlanning(models.Model):
    pentest = models.ForeignKey(Pentest, on_delete=models.CASCADE, null=True, blank=True,
                                related_name="AuditPreparationAndPlanning")
...
class AuditExecutionAndTesting(models.Model):
    pentest = models.ForeignKey(Pentest, on_delete=models.CASCADE, null=True, blank=True,
                                related_name="AuditExecutionAndTesting")
...
class ResultsAnalysisAndReporting(models.Model):
    pentest = models.ForeignKey(Pentest, on_delete=models.CASCADE, null=True, blank=True,
                                related_name="ResultsAnalysisAndReporting")
